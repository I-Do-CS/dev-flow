...
function DropdownMenuLabel({
  ...
  return (
    <MenuPrimitive.GroupLabel
      ...
      data-inset={inset}
      className={cn(
        "px-3 py-2.5 text-xs text-slate-500 data-inset:pl-9.5 dark:text-slate-400",
        className
      )}
      {...props}
    />
...
function DropdownMenuSubTrigger({
  ...
  return (
    <MenuPrimitive.SubmenuTrigger
      ...
      data-inset={inset}
      className={cn(
        "flex cursor-default items-center gap-2 rounded-2xl px-3 py-2 text-sm font-medium outline-hidden select-none focus:bg-slate-100 focus:text-slate-900 not-data-[variant=destructive]:focus:**:text-slate-900 data-inset:pl-9.5 data-popup-open:bg-slate-100 data-popup-open:text-slate-900 dark:focus:bg-slate-800 dark:focus:text-slate-50 dark:not-data-[variant=destructive]:focus:**:text-slate-50 dark:data-popup-open:bg-slate-800 dark:data-popup-open:text-slate-50 data-open:bg-slate-100 data-open:text-slate-900 dark:data-open:bg-slate-800 dark:data-open:text-slate-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
...
function DropdownMenuCheckboxItem({
  ...
  return (
    <MenuPrimitive.CheckboxItem
      ...
      data-inset={inset}
      className={cn(
        "relative flex cursor-default items-center gap-2.5 rounded-2xl py-2 pr-8 pl-3 text-sm font-medium outline-hidden select-none focus:bg-slate-100 focus:text-slate-900 focus:**:text-slate-900 data-inset:pl-9.5 dark:focus:bg-slate-800 dark:focus:text-slate-50 dark:focus:**:text-slate-50 data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      checked={checked}
      {...props}
...
function DropdownMenuSeparator({
  ...
  return (
    <MenuPrimitive.Separator
      ...
      className={cn(
        "-mx-1.5 my-1.5 h-px bg-slate-200/50 dark:bg-slate-800/50",
        className
      )}
      {...props}
    />
...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "ml-auto text-xs tracking-widest text-slate-500 group-focus/dropdown-menu-item:text-slate-900 dark:text-slate-400 dark:group-focus/dropdown-menu-item:text-slate-50",
        className
      )}
      {...props}
    />
